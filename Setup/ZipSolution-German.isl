; Deutch translation for custom messages was done by Nicolai Stoy, yots@gmx.net
; 
; ******************************************************
; ***                                                ***
...
CreateDesktopIcon=&Verknüpfung auf dem Desktop erstellen
CreateQuickLaunchIcon=Verknüpfung in der Schnellstartleiste erstellen
ProgramOnTheWeb=%1 im Internet
UninstallProgram=%1 deinstalllieren
...
PleaseInstallMsi=Für die Installation von ZipSolution wird die aktuelle Version des "Microsoft Installer" benötigt. Soll das Installationsprogramm die Seite zum Herunterladen des "Microsoft Installer" öffnen?
AlsoPleaseInstallDotNet4=ZipSolution benötigt auch die Windowskomponente "Microsoft .Net 4.0 Framework", nachdem der "Microsoft Installer" installiert wurde. Soll das Installationsprogramm die Seite zum Herunterladen des "Microsoft .Net 4.0 Framework" öffnen, bevor dieser beendet wird?'
PleaseInstallDotNet4=ZipSolution benötigt die Windowskomponente "Microsoft .Net 4.0 Framework". Soll das Installationsprogramm die Seite zum Herunterladen des "Microsoft .Net 4.0 Framework" öffnen, bevor dieser beendet wird?'