...
Changes=Обзор изменений
PleaseInstallMsi=Для установки ZipSolution Вам потребуется скачать и установить свежую версию компонента Windows "Microsoft Installer". Хотите открыть веб-страничку загрузки "Microsoft Installer" ?
AlsoPleaseInstallDotNet4=Также Вам понадобится затем скачать и установить компонент Windows "Microsoft .Net 4.0 Framework" после установки "Windows Installer". Хотите открыть веб-страничку загрузки "Microsoft .Net 4.0 Framework" перед завершением работы инсталлятора ?
PleaseInstallDotNet4=Для установки ZipSolution Вам понадобится скачать и установить компонент Windows "Microsoft .Net 4.0 Framework". Хотите открыть веб-страничку загрузки "Microsoft .Net 4.0 Framework" перед завершением работы инсталлятора ?
